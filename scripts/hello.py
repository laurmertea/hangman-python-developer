...
# If you fail, you'll be hanged, if you win, you'll survive. See also: Wikipedia
...
# - if that letter does not appear in the word and this letter hasn't already been guessed, 
# the computer counts it as a miss. A player can only afford 8 misses before the game is over.
# - if the letter does occur in the word, the computer notifies the player. If there are letters left to guess, 
# the computer invites the player to go on.
